...
class Process {
	...
	protected function fill_http_header_params_value( $params ) {
		 ...
		 * @param \WPFormsWebhooks\Process $process       Process object.
		 */
		return (array) apply_filters( 'wpforms_webhooks_process_fill_http_header_params_value', $filled_params, $params, $this );
	}
	...
	protected function fill_http_body_params_value( $params ) {
		 ...
		 * @param \WPFormsWebhooks\Process $process       Process object.
		 */
		return (array) apply_filters( 'wpforms_webhooks_process_fill_http_body_params_value', $filled_params, $params, $this );
	}
