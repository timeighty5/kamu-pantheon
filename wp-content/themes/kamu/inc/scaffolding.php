 ...
 */
function wds_kamu_display_scaffolding_section( $args = [] ) {
	// Set defaults.
	$defaults = [
	...
	$allowed_tags = wds_kamu_scaffolding_allowed_html();
	...
	<div class="scaffolding-document accordion <?php echo esc_attr( $class ); ?>">
		...
		<div class="accordion-item">
			...
			<header class="scaffolding-document-header display-flex flex-start space-between accordion-item-header">
				...
				<button type="button" class="scaffolding-button"><?php esc_html_e( 'Details', 'kamu' ); ?></button>
			...
			<div class="scaffolding-document-content accordion-item-content">
				...
				<?php if ( $args['arguments'] ) : ?>
					<p><strong><?php esc_html_e( 'Arguments', 'kamu' ); ?>:</strong></p>
				...
				<?php if ( $args['usage'] ) : ?>
					<p><strong><?php esc_html_e( 'Usage', 'kamu' ); ?>:</strong></p>
					<pre><?php echo esc_html( $args['usage'] ); ?></pre>
				<?php endif; ?>

				<?php if ( $args['output'] ) : ?>
					<p><strong><?php esc_html_e( 'HTML Output', 'kamu' ); ?>:</strong></p>
 ...
 */
function wds_kamu_scaffolding_allowed_html() {
 ...
 */
function wds_kamu_display_global_scaffolding_section( $args = [] ) {
	// Set defaults.
	$defaults = [
 ...
 * @author Carrie Forde
 */
function wds_kamu_hook_theme_scaffolding() {
...
add_action( 'wds_kamu_scaffolding_content', 'wds_kamu_hook_theme_scaffolding' );
